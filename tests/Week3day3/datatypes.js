...
//unknown
var nameF = "Abdur"; //console.log(data.toUpperCase()) // compile error. here we cannot perform opertaion 
...
var studentRecord = ["Arun", 29, true]; // here it should follow string order. If order chnages it gives compilation error
